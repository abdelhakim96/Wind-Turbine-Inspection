...
#ifndef MISSION_CONTROL_STATE_MACHINE_H
#define MISSION_CONTROL_STATE_MACHINE_H
...
class state_machine {
public:
    state_machine(const ros::NodeHandle &nh, const ros::NodeHandle &nh_private);
...
#endif //MISSION_CONTROL_STATE_MACHINE_H
