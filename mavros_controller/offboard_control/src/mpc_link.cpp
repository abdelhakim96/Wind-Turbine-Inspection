...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber attitude_sub = nh.subscribe<mav_msgs::RollPitchYawrateThrust>("/hummingbird/command/roll_pitch_yawrate_thrust", 1000,att_cb);
   ...
   // att_raw.body_rate.z = 0.0;
    ...
    while(ros::ok()){
        ...
        att_raw.body_rate.z = yaw_rate_d;
        //att_raw.thrust=thrust_r/50;
        att_raw.thrust=thrust_r/20;
